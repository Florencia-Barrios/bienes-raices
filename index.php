...
<main class="contenedor seccion">
    ...
    <div class="iconos-nosotros">
        <div class="icono">
            ...
            <h3>Seguridad</h3>
            <p>Corporis, maxime, magni rerum temporibus molestias reiciendis veritatis cupiditate error, vel
                expedita maiores assumenda quod? Autem facilis error reprehenderit, minus et nam.</p>
        </div>
        <div class="icono">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.html">
                    ...
                    <p class="informacion-meta">Escrito el: <span>28/07/2023</span> por: <span>Admin</span> </p>
